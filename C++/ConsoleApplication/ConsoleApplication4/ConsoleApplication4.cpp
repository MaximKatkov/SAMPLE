...
int main()
{
    cout << "<<< Multiplication of square-type matrices with a size of 1240x1240 >>>" << endl << "<<<The number of connected cores is initialized in code>>>" << endl;
    ...
    printf("Programm calculation time: %f\n", end / (double)CLOCKS_PER_SEC);
